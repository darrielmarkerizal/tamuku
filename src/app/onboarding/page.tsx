...
export default function OnboardingStep1Page() {
  return (
    <div className="min-h-dvh flex flex-col bg-bg">
      <main className="flex-grow flex flex-col w-full max-w-md mx-auto relative px-5 pb-5 pt-8">
        <header className="flex justify-between items-center w-full mb-8 sticky top-0 z-10 pt-4 pb-2 bg-bg">
          <StepIndicator total={4} current={1} />
          <Link
            href="/dashboard"
            className="font-display text-lg font-extrabold text-text-muted uppercase hover:opacity-80 transition-transform active:scale-95"
          >
            Lewati
          </Link>
        </header>
